...
|---|---|---|---|
| M0 | Foundation & plan | make the work resumable and the substrate pinned | in progress |
| M1 | Load-bearing spike | prove an out-of-tree plugin loads into `dsh` on Windows | todo |
